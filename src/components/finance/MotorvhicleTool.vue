<template>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="addToolOk('addToolRef')"
          >确 定</el-button
        >
      </span>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="editToolOk('editToolRef')"
          >确 定</el-button
        >
      </span>
...
export default {
    ...
    methods:{
        async getData(){
            const {data:res} = await this.$http.post('/carStandard/lookAllStandard')
        ...
        // 提交修改
         editToolOk(formName){
             console.log('修改点击')
                ...
                if (valid) {
                    const { data: res } = await this.$http.post('/carStandard/editStandard', null, { params: this.editTool })
        ...
        addToolOk(formName){
             console.log('修改点击')
                ...
                if (valid) {
                // 新增数据    
                const { data: res } = await this.$http.post('/carStandard/addStandard', null, { params: this.addTool })
